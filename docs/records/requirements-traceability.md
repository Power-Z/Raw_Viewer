...
| ID | 需求摘要 | 设计位置 | 计划 | 状态 |
|---|---|---|---|---|
| UI-001 | 顶部主菜单 | 架构 6 | P1-02 | Planned |
| UI-002 | 底部状态栏显示坐标、信号和图片信息 | 架构 6、10 | P1-02/P1-05 | Planned |
| UI-003 | 左 20% / 中 60% / 右 20% 三栏与内部区域 | 架构 6 | P1-02 | Planned |
| UI-004 | Dark/Light/Gray/Yellow/Red 主题 | 架构 6 | P1-02 | Planned |
